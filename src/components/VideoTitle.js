...
const VideoTitle = ({title, overview}) => {
  return (
    <div className="pt-[25%] md:pt-[20%] p-4 md:px-8 w-screen aspect-video absolute text-white bg-gradient-to-r from-black">
        ...
        <button className="md:bg-white bg-gray-700 md:text-black text-white px-5 md:px-10 my-2 py-1 md:py-2 text-lg rounded-md opacity-75 bg-opacity-70 hover:bg-opacity-80"> Play</button>
