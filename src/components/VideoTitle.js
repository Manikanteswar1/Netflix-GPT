...
const VideoTitle = ({title, overview}) => {
  return (
    <div className="pt-[20%] p-4 md:px-8 w-screen aspect-video absolute text-white bg-gradient-to-r from-black">
        ...
        <p className="hidden md:block py-6 text-lg w-1/3 opacity-60">{overview}</p>
        <button className="md:bg-white bg-gray-700 md:text-black text-white px-5 md:px-10 md:p-2 my-2 p-1 md:m-0 text-lg rounded-md opacity-75 bg-opacity-70 hover:bg-opacity-80"> Play</button>
